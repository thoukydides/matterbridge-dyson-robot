...
- **🐞 [Bug report](https://github.com/thoukydides/matterbridge-dyson-robot/issues/new?template=bug-report.yml)** issue template with `bug` label
...
- **🚧 [Feature Request](https://github.com/thoukydides/matterbridge-dyson-robot/issues/new?template=feature-request.yml)** issue template with `enhancement` label
...
- **👌 [Compatible Device](https://github.com/thoukydides/matterbridge-dyson-robot/issues/new?template=compatible-device.yml)** issue template with `compatible device` label
  - The README.md includes a list of devices that have been tested and confirmed compatible; additions to this list should be reported using the Compatible Device template
  - Accept reports submitted using other templates, even if combined with other issues

- **💬 [Discussions](https://github.com/thoukydides/matterbridge-dyson-robot/discussions)**
...
- **🤖 [Ask Dosu](https://github.dosu.com/thoukydides/matterbridge-dyson-robot)**

...
- **🐞 [Bug report](https://github.com/thoukydides/matterbridge-dyson-robot/issues/new?template=bug-report.yml)** issue template
...
- **🚧 [Feature Request](https://github.com/thoukydides/matterbridge-dyson-robot/issues/new?template=feature-request.yml)** issue template
...
- **👌 [Compatible Device](https://github.com/thoukydides/matterbridge-dyson-robot/issues/new?template=compatible-device.yml)**
